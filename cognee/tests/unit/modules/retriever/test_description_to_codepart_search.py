...
@pytest.mark.asyncio
async def test_code_description_to_code_part_lua_no_results():
    """Test that code_description_to_code_part handles no search results for Lua."""
    ...
    with (
        ...
        result = await code_description_to_code_part("search query", mock_user, 2, language="lua")

        assert result == []


@pytest.mark.asyncio
async def test_code_description_to_code_part_lua_invalid_query():
    """Test that code_description_to_code_part raises ValueError for invalid query for Lua."""
    ...
    with pytest.raises(ValueError, match="The query must be a non-empty string."):
        ...
        await code_description_to_code_part("", mock_user, 2, language="lua")


@pytest.mark.asyncio
async def test_code_description_to_code_part_lua_invalid_top_k():
    """Test that code_description_to_code_part raises ValueError for invalid top_k for Lua."""
    ...
    with pytest.raises(ValueError, match="top_k must be a positive integer."):
        ...
        await code_description_to_code_part("search query", mock_user, 0, language="lua")


@pytest.mark.asyncio
async def test_code_description_to_code_part_lua_initialization_error():
    """Test that code_description_to_code_part raises RuntimeError for engine initialization errors for Lua."""
    ...
    with (
        ...
        with pytest.raises(
            ...
            await code_description_to_code_part("search query", mock_user, 2, language="lua")


@pytest.mark.asyncio
async def test_code_description_to_code_part_lua_execution_error():
    """Test that code_description_to_code_part raises RuntimeError for execution errors for Lua."""
